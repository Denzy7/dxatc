...
typedef enum
{
    DXATC_ENGINE_AIRCRAFT_FLIGHT_PHASE_PARKED,
    DXATC_ENGINE_AIRCRAFT_FLIGHT_PHASE_TAXI,
    DXATC_ENGINE_AIRCRAFT_FLIGHT_PHASE_TAKEOFF,
    DXATC_ENGINE_AIRCRAFT_FLIGHT_PHASE_CLIMB,
    DXATC_ENGINE_AIRCRAFT_FLIGHT_PHASE_CRUISE,
    DXATC_ENGINE_AIRCRAFT_FLIGHT_PHASE_DESCEND,
    DXATC_ENGINE_AIRCRAFT_FLIGHT_PHASE_APPROACH,
    DXATC_ENGINE_AIRCRAFT_FLIGHT_PHASE_LANDING,

    DXATC_ENGINE_AIRCRAFT_FLIGHT_PHASE_COUNT
}DxAtcAircraftFlightPhase;
...
typedef struct
{
    DxAtcAircraftFlightPhase phase;
